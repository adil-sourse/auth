  ...
  return (
    <>
      ...
      >
            ...
            <Button
              ...
              className={`${
                transparent && !menuOpen
                  ? "bg-transparent md:bg-transparent text-white"
                  : ""
              }`}
            >
              {user ? "Аккаунт" : "Вход"}
        ...
        <div
          className={`md:hidden bg-white text-black shadow-inner overflow-hidden transition-all duration-300 ease-in-out ${
            menuOpen
